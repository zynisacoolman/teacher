...
public class TWDChildAdapter extends BaseAdapter {
    ...
    public TWDChildAdapter(Context context, List<List<String>> specailList) {
    ...
    public interface CordUpdateListener {
        public void onUpdateClick(int postion, TWDChildAdapter adapter, List<List<String>> listdata);
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.cords_signature_buton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                cordUpdateListener.onUpdateClick(position,TWDChildAdapter.this,specailList);
            }
        });
