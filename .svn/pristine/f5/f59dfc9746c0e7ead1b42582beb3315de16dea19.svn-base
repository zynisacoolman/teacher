...
public class MZBLFragmentAdapter extends BaseAdapter {
    ...
    public MZBLFragmentAdapter(Context context, List<String> specailList, int index) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.adapter_fragmentmzbl, null);
