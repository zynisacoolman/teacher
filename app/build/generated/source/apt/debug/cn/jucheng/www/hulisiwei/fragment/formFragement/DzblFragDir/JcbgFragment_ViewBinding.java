...
public class JcbgFragment_ViewBinding implements Unbinder {
  private JcbgFragment target;

  @UiThread
  public JcbgFragment_ViewBinding(JcbgFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    JcbgFragment target = this.target;
