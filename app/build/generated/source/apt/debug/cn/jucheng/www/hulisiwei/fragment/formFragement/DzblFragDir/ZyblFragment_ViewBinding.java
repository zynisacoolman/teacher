...
public class ZyblFragment_ViewBinding implements Unbinder {
  private ZyblFragment target;

  @UiThread
  public ZyblFragment_ViewBinding(ZyblFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ZyblFragment target = this.target;
