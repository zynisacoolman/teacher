...
import cn.jucheng.www.hulisiwei.adapter.fragmentAdapter.HLJL3FragmentAdapter;
...
public class Hljld3Fragment extends BaseFragment implements TWDFragmentAdapter.ToastListener,AbsListView.OnScrollListener {
    ...
    public void initAdapter() {
        adapter = new HLJL3FragmentAdapter(getActivity(), UserMessage.fragmentHead, pages);
