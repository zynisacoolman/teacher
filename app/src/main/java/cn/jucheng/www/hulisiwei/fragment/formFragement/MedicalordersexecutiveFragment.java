...
import cn.jucheng.www.hulisiwei.adapter.fragmentAdapter.MedicalordfragmentAdapter;
...
public class MedicalordersexecutiveFragment extends BaseFragment implements MedicalordfragmentAdapter.ToastListener,AbsListView.OnScrollListener {
    ...
    public void initAdapter() {
        adapter = new MedicalordfragmentAdapter(getActivity(), UserMessage.fragmentHead, pages);
    ...
    public void setBiaodan(String message){
        ...
        if(biaoDanType == 19){
            ...
            if(UserMessage.medicalord_Message.size() >= yiZhuHangHaos){
