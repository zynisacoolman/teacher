...
/**
 * Created by akitaka on 2017/9/25.
 *
 * @filename FitHeightEditText
 * @describe
 * @email 960576866@qq.com
 */

public class FitHeightEditText extends EditText {
	private Paint mTextPaint;
	private float mMaxTextSize; // 获取当前所设置文字大小作为最大文字大小
	private float mMinTextSize = 8; // 最小的字体大小
	private int attr2;

	public FitHeightEditText(Context context) {
		super(context);
	}

	public FitHeightEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
