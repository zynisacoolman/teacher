...
import cn.jucheng.www.hulisiwei.adapter.fragmentAdapter.JCBGFragmentAdapter;
...
public class JcbgFragment extends BaseFragment implements TWDFragmentAdapter.ToastListener,AbsListView.OnScrollListener {
    ...
    public void initAdapter() {
        adapter = new JCBGFragmentAdapter(getActivity(), UserMessage.fragmentHead, pages);
