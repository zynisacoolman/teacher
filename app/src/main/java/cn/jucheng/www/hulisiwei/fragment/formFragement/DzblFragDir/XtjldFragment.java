...
public class XtjldFragment extends BaseFragment implements TWDFragmentAdapter.ToastListener,AbsListView.OnScrollListener {
    ...
    public void initAdapter() {
        adapter = new XTJLDFragmentAdapter(getActivity(), UserMessage.fragmentHead, pages);
