...
public class HLJL3FragmentAdapter extends BaseAdapter {
    ...
    public HLJL3FragmentAdapter(Context context, List<String> specailList, int index) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.adapter_fragmentcryljld, null);
