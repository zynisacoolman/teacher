...
import cn.jucheng.www.hulisiwei.adapter.fragmentAdapter.TGJCFragmentAdapter;
...
public class TgjcFragment extends BaseFragment implements TWDFragmentAdapter.ToastListener,AbsListView.OnScrollListener {
    ...
    public void initAdapter() {
        adapter = new TGJCFragmentAdapter(getActivity(), UserMessage.fragmentHead, pages);
