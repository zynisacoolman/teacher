...
public class Juchengesp {
    ...
    private List<Special_disposal> special_disposal;
    public void setSpecial_disposal(List<Special_disposal> special_disposal) {
         this.special_disposal = special_disposal;
     }
