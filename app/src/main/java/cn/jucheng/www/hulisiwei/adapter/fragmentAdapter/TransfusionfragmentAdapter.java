...
public class TransfusionfragmentAdapter extends BaseAdapter implements TransfusionAdapter.TranUpdateListener {
    ...
    public TransfusionfragmentAdapter(Context context, List<String> specailList, int index) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.adapter_fragment_transfusion, null);
            holder = new ViewHolder();
            holder.transfusion_name = (TextView) convertView.findViewById(R.id.transfusion_name);
            holder.transfusion_sex = (TextView) convertView.findViewById(R.id.transfusion_sex);
            holder.transfusion_age = (TextView) convertView.findViewById(R.id.transfusion_age);
            holder.transfusion_division = (TextView) convertView.findViewById(R.id.transfusion_division);
            holder.transfusion_bednumber = (TextView) convertView.findViewById(R.id.transfusion_bednumber);
            holder.transfusion_medicalrecord_number = (FitHeightTextView) convertView.findViewById(R.id.transfusion_medicalrecord_number);
            holder.transfusion_list = (ListView) convertView.findViewById(R.id.transfusion_list);
            holder.transfusion_years = (TextView) convertView.findViewById(R.id.transfusion_years);
            holder.transfusion_mouth = (TextView) convertView.findViewById(R.id.transfusion_mouth);
            holder.transfusion_day = (TextView) convertView.findViewById(R.id.transfusion_day);
            holder.transfusion_checkuser = (TextView) convertView.findViewById(R.id.transfusion_checkuser);
            holder.transfusion_carryout = (TextView) convertView.findViewById(R.id.transfusion_carryout);
            holder.transfusion_page_number = (TextView) convertView.findViewById(R.id.transfusion_page_number);
        ...
        if (specailList.size() >= 0 || specailList != null) {
            holder.transfusion_name.setText(CommUtils.getListString(specailList, 0));
            holder.transfusion_sex.setText(CommUtils.getListString(specailList, 1));
            holder.transfusion_age.setText(CommUtils.getListString(specailList, 2));
            holder.transfusion_division.setText(CommUtils.getListString(specailList, 3));
            holder.transfusion_bednumber.setText(CommUtils.getListString(specailList, 4));
            holder.transfusion_medicalrecord_number.setText(CommUtils.getListString(specailList, 5));
    ...
    class ViewHolder {
        TextView transfusion_name;//姓名
        TextView transfusion_sex;//性别
        TextView transfusion_age;//年龄
        TextView transfusion_division;//科室
        TextView transfusion_bednumber;//床号
        FitHeightTextView transfusion_medicalrecord_number;//病案号
