...
public class Hljld2Fragment extends BaseFragment implements TWDFragmentAdapter.ToastListener,AbsListView.OnScrollListener {
    ...
    public void initAdapter() {
        adapter = new HLJL2FragmentAdapter(getActivity(), UserMessage.fragmentHead, pages);
