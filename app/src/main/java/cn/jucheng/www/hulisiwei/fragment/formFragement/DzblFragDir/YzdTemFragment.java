...
public class YzdTemFragment extends BaseFragment implements TWDFragmentAdapter.ToastListener ,AbsListView.OnScrollListener {
    ...
    public void initAdapter() {
        adapter = new YZDTempFragmentAdapter(getActivity(), UserMessage.fragmentHead, pages);
